...
const (
	...
	defaultWindows2k8ContainerDisk         = "registry:5000/windows2k8-container-disk:latest"
...
var (
	...
	windows2k8ContainerDisk         string
...
func init() {
	...
	flag.StringVar(&windows2k8ContainerDisk, "windows-2k8-container-disk",
		defaultWindows2k8ContainerDisk, "Windows Server 2008 container disk used by functional tests")
